...
public abstract class Item {
     ...
     * @param description la descrizione dell'oggetto (non nulla).
    ...
    /** @return il numero di utilizzi rimanenti (-1 se infiniti). */
     ...
     */
    public boolean isUnbreakable() { return durability == -1; }
     ...
     */
    public boolean isUsable() { return isUnbreakable() || durability > 0; }
